  ...
  constructor(private hooks: { onOpen?: () => void; onClose?: () => void }) {
    ...
    this.dialog.innerHTML = `
      ...
      <ul>
        ...
        <li>직업 전용 장비가 있다 — 나무 활은 궁수만, 나무 지팡이와 가죽 로브는
          마법사·힐러만 쓴다. 로브는 몸을 막기보다 마력을 돕는다. 누구 것인지는
          입으려 할 때 그대로 알려 준다. 물론 검·갑옷처럼 모두의 장비도 있다</li>
        <li>등급이 높은 장비에는 최소 레벨이 있다 — 정련은 3레벨, 울림은 4레벨부터</li>
        <li>울림 세트를 2개 이상 입으면 보너스가 붙는다</li>
